...
class TransferKVChunk:
    ...
    layer_id: Optional[int] = None  # None = all-layer transfer, int = single-layer
    cuda_event: object = None  # torch.cuda.Event for GPU-transfer sync
            ...
            try:
                ...
                for req in reqs_to_be_processed:
                    if not req.is_dummy:
                        ...
                        if kv_chunk.layer_id is not None:
