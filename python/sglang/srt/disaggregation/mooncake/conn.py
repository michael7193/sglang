...
class MooncakeKVManager(CommonKVManager):
    ...
    def add_transfer_request(
        ...
        # queue, which enables early abort with failed sessions. Layer-pipelined
        # sends also rely on this same-room FIFO ordering so that the final
        # metadata/status chunk is processed after all preceding layer chunks.
